...
func InitDb() (*gorm.DB, error) {
	db, err := gorm.Open("mysql",
		"root:zhang123@tcp(127.0.0.1:3306)/search_house?charset=utf8&parseTime=True&loc=Local")
	...
	if err == nil {
		...
		db.Set("gorm:table_options", "ENGINE=InnoDB DEFAULT CHARSET=utf8").AutoMigrate(new(User), new(House), new(Area), new(Facility), new(HouseImage), new(OrderHouse))
		return db, nil
	}
	return nil, err
}
